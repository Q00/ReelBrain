...
The app bundle is ad-hoc signed with hardened runtime enabled, and strict bundle verification passed. The PKG installer is not Developer ID signed or Apple-notarized, so macOS may require Control-clicking the package or app and choosing **Open**.
